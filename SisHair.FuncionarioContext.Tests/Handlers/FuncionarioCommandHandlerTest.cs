...
//using NSubstitute;
//using SisHair.CoreContext.BaseInterfaces.Events;
...
//        private IMediatorHandler handler;

//        [TestInitialize]
//        public void Init()
//        {
//            funcionarioService = Substitute.For<IFuncionarioService>();
//            var cadastrarFuncionarioEventHandler = Substitute.For<IEventHandler<CadastrarFuncionarioEvent>>();

//            this.handler = Substitute.ForPartsOf<IMediatorHandler>();
//        }
